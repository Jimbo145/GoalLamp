...
bool testAniFunc(NeoPixelStrip* ledStrip, uint16_t frameNum, NhlGame* game, AnimationExtra extra);
...
class Animation {
    public:
        ...
        Animation(bool (*f)(NeoPixelStrip*, uint16_t,  NhlGame*, AnimationExtra), NeoPixelStrip* s, NhlGame* g = nullptr, RgbColor extraColor = NULL, uint16_t extraInt = NULL){ 
            animationFunc = f;
            ledStrip = s;
            game = g;
            extra.color = extraColor;
            extra.uInteger = extraInt;
        } 
